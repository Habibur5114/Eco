                        ...
                        <div class="accordion-item mb-4">
                            ...
                            <div id="accordion-filter-price" class="accordion-collapse collapse show border-0"
                                ...
                                <input class="price-range-slider" type="text" name="price_range" value=""
                                    ...
                                    data-slider-value="[0,1000]" data-currency="$" />
                                ...
                                <div class="slide-split h-100 d-block d-md-flex overflow-hidden">
                                    ...
                                    <div class="slide-split_media position-relative">
                                        <div class="slideshow-bg" style="background-color: #f5e6e0;">
                                            <img src="{{ asset($slider->image) }}" width="630" height="450"
                ...
                <div class="d-flex justify-content-between mb-4 pb-md-2">
                    ...
                    <div
                        ...
                        <select class="shop-acs__select form-select w-auto border-0 py-0 order-1 order-md-0"
                            aria-label="Sort Items" name="total-number" id="productSortBy" onchange="shopFilter()">
                            <option disabled <?= !isset($_GET['sort_by']) ? 'selected' : '' ?>>Sorting</option>
                            <option value="featured"
                                <?= isset($_GET['sort_by']) && $_GET['sort_by'] == 'featured' ? 'selected' : '' ?>>Featured
                            </option>
                            <option value="high_to_low"
                                <?= isset($_GET['sort_by']) && $_GET['sort_by'] == 'high_to_low' ? 'selected' : '' ?>>High
                                To Low Price</option>
                            <option value="low_to_high"
                                <?= isset($_GET['sort_by']) && $_GET['sort_by'] == 'low_to_high' ? 'selected' : '' ?>>Low To
                                High Price</option>
                        </select>
