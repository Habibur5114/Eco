...
<h5><b>Childcategory Create</b></h5>
<div class="container mt-4">
    <div class="row">
        <form action="{{ route('childcategory.save') }}" method="POST" enctype="multipart/form-data">
            @csrf
           ...
           <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <textarea name="meta_description" id="summernote1"></textarea>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
