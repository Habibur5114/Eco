            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" id="name" class="form-control" name="name" placeholder="Name" value="{{$subcategory->name}}" required>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <textarea name="meta_description" id="summernote" >{!!$subcategory->meta_description !!}</textarea>
                    </div>
                </div>
            </div>
